          ...
          >
            <div className='mb-4'>
              ...
              <input
                type='text'
                name='from_name'
                className='block md:text-lg text-md w-full p-3 border border-solid border-royalGreen rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-800'
            ...
            <button
              type='submit'
              className='block md:text-lg text-md mediumSmall:w-fit w-full bg-royalGreen text-white py-3 px-4 rounded-lg font-semibold hover:bg-gray-700 transition-colors duration-200'
            >
              Send Message
            </button>
          </form>
