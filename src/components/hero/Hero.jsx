    ...
    <>
      <section className='hero relative w-full h-screen overflow-hidden'>
        ...
        <div className='wrapper h-full top-0 left-[50%] -translate-x-[50%] z-30 absolute'>
          <div className='hero-content md:px-20 md:items-start items-center w-full md:justify-center md:pt-0 pt-20 h-full flex flex-col md:gap-16 gap-8'>
            ...
            <div className='flex md:gap-4 md:flex-row flex-col w-full text-center'>
              <Link
